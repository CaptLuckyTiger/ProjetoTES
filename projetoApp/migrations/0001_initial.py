# Generated by Django 4.2.16 on 2025-01-26 02:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atividade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='projetoApp.atividade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atividade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='projetoApp.atividade')),
                ('alunos', models.ManyToManyField(to='projetoApp.aluno', verbose_name='Alunos')),
                ('participantes', models.ManyToManyField(to='projetoApp.participante', verbose_name='Participantes')),
                ('professores', models.ManyToManyField(to='projetoApp.professor', verbose_name='Professores')),
            ],
        ),
        migrations.CreateModel(
            name='Convite',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atividade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projetoApp.atividade')),
