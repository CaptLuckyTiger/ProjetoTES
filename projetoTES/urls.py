...
urlpatterns = [
    ...
    path('admin_checkin/validar/<int:pk_evento>/<int:pk_inscricao>', views.adminCheckinValidar, name = "adminCheckinValidar"),
    path('admin_checkin/invalidar/<int:pk_evento>/<int:pk_inscricao>', views.adminCheckinInvalidar, name = "adminCheckinInvalidar"),
    path('admin_checkin/validar_aluno/<int:pk_evento>/<int:pk_aluno>', views.adminCheckinValidarAluno, name = "adminCheckinValidarAluno"),
    path('admin_checkin/invalidar_aluno/<int:pk_evento>/<int:pk_aluno>', views.adminCheckinInvalidarAluno, name = "adminCheckinInvalidarAluno"),
