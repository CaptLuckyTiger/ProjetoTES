...
urlpatterns = [
    ...
    path('admin_checkin/validar/<int:pk_atividade>/<int:pk_inscricao>', views.adminCheckinValidar, name = "adminCheckinValidar"),
    path('admin_checkin/invalidar/<int:pk_atividade>/<int:pk_inscricao>', views.adminCheckinInvalidar, name = "adminCheckinInvalidar"),
    ...
    path('admin_evento_visualizar/<int:pk>/', views.adminVisualizarEvento, name = "adminVisualizarEvento"),
    path('admin_avaliar/<int:pk_aluno>/<int:pk_evento>', views.adminAvaliar, name = "adminAvaliar"),
    path('admin_avaliar/cadastrar/<int:pk_aluno>/<int:pk_evento>', views.adminCadastrarAvaliacao, name = "adminCadastrarAvaliacao"),
